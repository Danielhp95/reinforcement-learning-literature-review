...
Some notable off policy algorithms are. Q-learning, deep Q-learning, deterministic policy gradient (Silver et al 2014). Deep deterministic policy gradient~\citep{Lillicrap2015}
